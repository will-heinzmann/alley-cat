...
const blogPosts = [
  ...
  { slug: "top-100-bowling-alleys-in-the-us", title: "Top 100 Bowling Alleys in the US (2026) — The Definitive Ranking", description: "The definitive ranking of the top 100 bowling alleys in the US for 2026 — historic landmarks, boutique lounges, and beloved local institutions, with why each made the list.", content: "From a 1908 Milwaukee tavern with hand-set pins to a 78-lane tournament cathedral in Reno, America's bowling alleys are some of the most characterful gathering places in the country. We ranked the 100 best — weighing history, design, atmosphere, food and drink, and the feeling of a great house. The top 10 include Highland Park Bowl (Los Angeles), Brooklyn Bowl, Holler House (Milwaukee, oldest sanctioned lanes), Garden Bowl (Detroit, oldest active), the National Bowling Stadium (Reno), Pinz (Studio City), the original Punch Bowl Social (Denver), The Gutter (Brooklyn), Fulton Alley (New Orleans), and 10pin Bowling Lounge (Chicago). Use Alley Cat's directory of 2,000+ alleys to find and rate your favorites." },
  { slug: "top-100-beers-for-bowling-alleys", title: "Top 100 Beers to Drink at a Bowling Alley (2026 Ranking)", description: "The ultimate ranking of the 100 best beers to drink at a bowling alley — heavy on IPAs and light lagers, led by Bell's Two Hearted Ale and Guinness Draught.", content: "The right beer turns a good bowling night into a great one. We ranked 100 real beers by lane-side drinkability, crowd-pleasing power, and availability — leaning into the two categories that rule the alley: crushable IPAs and easy-drinking light lagers. Bell's Two Hearted Ale (American IPA, 7.0%) takes the top spot and Guinness Draught (Irish dry stout, 4.2%) is second. From there the list spans craft IPA kings like Sierra Nevada Hazy Little Thing, Founders All Day IPA, Stone IPA, and Heady Topper, to light classics like Miller Lite, Coors Light, Modelo, Yuengling, and Pabst Blue Ribbon." },
  { slug: "best-bowling-alley-food-in-the-us", title: "The Best Bowling Alley Food in the US (2026 Guide)", description: "Where the food is the main event: a guide to the best bowling alley food spots in the US — from wood-fired pizza to oxtail soup and the iconic alley cheeseburger.", content: "American bowling alleys are in a full-blown food renaissance. The classic snack-bar cheeseburger never left — it just got serious company. Highland Park Bowl in LA serves restaurant-grade wood-fired pizza, Brooklyn Bowl runs Blue Ribbon's celebrated fried chicken, Aiea Bowl in Hawaii is famous for its oxtail soup, and Pinstripes, Punch Bowl Social, and Splitsville serve genuine bistro-quality menus. We also cover the iconic dishes that built the canon: the alley cheeseburger, nachos, soft pretzels, wings, loaded fries, and fried pickles." },
];
...
// --- Varied description generator (mirrors src/lib/alleyDescription.ts) ---
...
function generateAlleyDescription(name: string, city: string, state: string, laneCount: number, rating: number): string {
